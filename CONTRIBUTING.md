# Contributing to `buffr-downloads`

Thanks for considering a contribution. `buffr-downloads` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-downloads.git
cd buffr-downloads
